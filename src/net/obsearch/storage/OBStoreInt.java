package net.obsearch.storage;
  ...
  /**
   * OBStoreInt abstracts a generic storage system. The purpose of
   ...
   * utility methods for keys of type int.
   * @author Arnoldo Jose Muller Molina
   */
  
  public interface OBStoreInt extends OBStore<TupleInt> {
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleInt> processRange(int low, int high) throws OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleInt> processRangeReverse(int low, int high) throws OBStorageException;
       ...
       */
      OperationStatus put(int key, byte[] value) throws OBStorageException;
      ...
      */
     OperationStatus delete(int key)throws OBStorageException;
