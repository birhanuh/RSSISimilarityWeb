package net.obsearch.storage;
  ...
  /**
   * OBStoreDouble abstracts a generic storage system. The purpose of
   ...
   * utility methods for keys of type double.
   * @author Arnoldo Jose Muller Molina
   */
  
  public interface OBStoreDouble extends OBStore<TupleDouble> {
       ...
       */
      byte[] getValue(double  key) throws IllegalArgumentException, OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleDouble> processRange(double low, double high) throws OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleDouble> processRangeReverse(double low, double high) throws OBStorageException;
       ...
       */
      OperationStatus put(double key, byte[] value) throws OBStorageException;
      ...
      */
     OperationStatus delete(double key)throws OBStorageException;
