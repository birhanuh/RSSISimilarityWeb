package net.obsearch.storage;
  ...
  /**
   * OBStoreFloat abstracts a generic storage system. The purpose of
   ...
   * utility methods for keys of type float.
   * @author Arnoldo Jose Muller Molina
   */
  
  public interface OBStoreFloat extends OBStore<TupleFloat> {
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleFloat> processRange(float low, float high) throws OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleFloat> processRangeReverse(float low, float high) throws OBStorageException;
       ...
       */
      OperationStatus put(float key, byte[] value) throws OBStorageException;
      ...
      */
     OperationStatus delete(float key)throws OBStorageException;
