package net.obsearch.storage;
  ...
  /**
   * OBStoreLong abstracts a generic storage system. The purpose of
   ...
   * utility methods for keys of type long.
   * @author Arnoldo Jose Muller Molina
   */
  
  public interface OBStoreLong extends OBStore<TupleLong> {
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleLong> processRange(long low, long high) throws OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleLong> processRangeReverse(long low, long high) throws OBStorageException;
       ...
       */
      OperationStatus put(long key, byte[] value) throws OBStorageException;
      ...
      */
     OperationStatus delete(long key)throws OBStorageException;
