package net.obsearch.storage;
  ...
  /**
   * OBStoreByte abstracts a generic storage system. The purpose of
   ...
   * utility methods for keys of type byte.
   * @author Arnoldo Jose Muller Molina
   */
  
  public interface OBStoreByte extends OBStore<TupleByte> {
       ...
       */
      byte[] getValue(byte  key) throws IllegalArgumentException, OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleByte> processRange(byte low, byte high) throws OBStorageException;
       ...
       *                 the nature of the error.
       */
      CloseIterator<TupleByte> processRangeReverse(byte low, byte high) throws OBStorageException;
