package net.obsearch.result;
   ...
   * meant to be used with objects OBShort. 
   * @author Arnoldo Jose Muller Molina
   * @since 0.7
   */
  
  public final class OBPriorityQueueShort<O> extends AbstractOBPriorityQueue<OBResultShort<O>> {
       ...
       */
      public OBPriorityQueueShort(int k){
          super(k);
      }
      ...
      /**
       * Add the given object, object id and distance of type short to the
       ...
       */
      public boolean add(long id, O obj, short distance) throws InstantiationException, IllegalAccessException {
          if (queue.size() == k) {
              // recycle objects.
      ...
      *             If there is a problem when instantiating objects O
      */
     public void addMax(long id, O obj, short distance) throws InstantiationException, IllegalAccessException {
         if (queue.size() == k) {
             // recycle objects.
 		 ...
 		 */
 		private boolean validateAddition(OBResultShort<O> c){
 				Iterator<OBResultShort<O>> it = iterator();
 				while(it.hasNext()){
