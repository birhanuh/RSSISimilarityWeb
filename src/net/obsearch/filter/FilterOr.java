...
/**
 * FilterOr creates an or of filters. If any of the 
 * added filters returns true, this filter also returns true.
 * 
 * @author Arnoldo Jose Muller Molina
 */

public final class FilterOr<O extends OB> implements Filter<O> {
