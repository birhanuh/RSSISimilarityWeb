package net.obsearch.ob;
   ...
   */
  /**
   * Any Object whose distance function returns longs must implement this
  ...
  public interface OBLong extends OB{
  
      /**
       * Calculates the similarity of "this" and "object". The function must
       * satisfy the triangular inequality and return a long.
       * @param object
       *            The object of type OBLong to be compared
       * @param result
       ...
       */
      long distance(OBLong object) throws OBException;
  }
