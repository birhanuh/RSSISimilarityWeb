package net.obsearch.ob;
   ...
   */
  /**
   * Any Object whose distance function returns shorts must implement this
  ...
  public interface OBShort extends OB{
  
      /**
       * Calculates the similarity of "this" and "object". The function must
       * satisfy the triangular inequality and return a short.
       * @param object
       ...
       */
      short distance(OBShort object) throws OBException;
  }
